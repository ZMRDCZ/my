@echo off
echo 🚀 Начинаем деплой на GitHub Pages с исправлением путей...
...
REM Исправляем пути к assets
echo 🔧 Исправляем пути к assets...
powershell -Command "(Get-Content .output\public\index.html) -replace '/_nuxt/', '/my/_nuxt/' | Set-Content .output\public\index.html"
